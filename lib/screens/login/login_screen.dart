...
class _LoginScreenState extends State<LoginScreen> {
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                Center(
                  child: Image.asset(AssetsManager.logo, height: height * 0.23),
                ),
                SizedBox(height: 24),
                CustomTextField(
                  hint: "email".tr(),
  ...
  signin() async {
    try {
      ...
      DialogUtils.toastMessage("Login Successfully");
      ...
      if (e.code == 'user-not-found') {
        ...
        DialogUtils.DialogMessage(
          context: context,
          content: ' Firebase error: ${e.code} - ${e.message}',
          message: ' Confirm Auth',
          positiveOnPressed: () {
            Navigator.pop(context);
          },
